    ...
    for n, v in ingresses.items():
        ...
        if allowed_ip:
            for m, w in cfg.AllowedIp.items():
                ...
                auto_get_props(r_SGRule, **kwargs, res_obj_type="AWS::EC2::SecurityGroup", prop_obj_cfm_name="Ingress")
                auto_get_props(r_SGRule, f"AllowedIp{m}", res_obj_type="AWS::EC2::SecurityGroup", prop_obj_cfm_name="Ingress")
